...
簡易版では**静止画生成**のみ利用可能で、生成中の待ち時間に**ミニゲーム**で遊ぶことができます

1. 上記リンクにアクセスします。
2. メニューから「静止画生成」を選択します。

![home](img/picture1.png)

3. テキストボックスに任意のプロンプト（例：「吠える犬」）を入力します。

![image-gen](img/picture2.png)

4. 「送信」ボタンをクリックすると、生成された画像が表示されます。
   （生成された画像はコピーやダウンロードが可能です。）
5. 生成中は「ミニゲーム」を選択して遊ぶことができます。

![minigame](img/picture4.png)
